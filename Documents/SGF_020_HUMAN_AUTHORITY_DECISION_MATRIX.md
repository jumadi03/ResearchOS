...
- Authority basis: project-owner direction bounded by SGF-000
- Recorded: 2026-07-19
...
This standard is operational guidance for existing and future ResearchOS
contracts. It does not claim that every control described here is already
implemented. Section 13 separates existing enforcement from required
